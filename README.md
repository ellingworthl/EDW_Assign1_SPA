...
## UI Design.
The images show the Home (Landing.js) page in collapsed and full-page format.
...
+ /venues - will show list of venues (under construction)
+ /venues/:clubid - will show specific detail about the club (under construction)
...
None so far. Registration not built.
